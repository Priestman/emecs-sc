...
$result3 = mysql_query("SELECT `visasup` FROM `add_visasup` WHERE `key`='$login'",$db); 
...
$accomp_all = $accomp*165+$acc_visasup*1.1;
...
$full = $full_sum+($forwarding*1.1)+($need_visa*1.1)+$easybird;
...
<p align="left", face="Arial">Payment in USD.</p>
<p align="left", face="Arial">Account № 40501840039000000003<br>
...
<table class="fee" border="1">
   ...
   <tr><td>Extra additional papers</td><td>$sum</td><td>$stat</td><td>$full_sum</td></tr>
   <tr><td>Visa support</td><td>$visa_service</td><td>$ok</td><td>$visa_service</td></tr>
   <tr><td>Accompanying participants</td><td>165</td><td>$accomp</td><td>$accomp_all</td></tr>
