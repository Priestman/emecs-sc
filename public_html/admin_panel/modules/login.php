...
$result = mysql_query("SELECT * FROM adm_access WHERE login='$login' AND password='$password'",$db); //извлекаем из базы все данные о пользователе с введенным логином
...
echo "<html><head><meta http-equiv='Refresh' content='0; URL=http://emecs-sc2016.com/admin_panel/index.html'></head></html>";
